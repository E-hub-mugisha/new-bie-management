        ...
        <table class="table dataTable table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.visitor.profile', $visitor->id) }}" class="btn btn-info btn-sm">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.visitors.newStore', $visitor->id ) }}" method="POST">
                                    @csrf
